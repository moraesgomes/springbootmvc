...
public interface PessoaRepository extends JpaRepository<Pessoa, Long> {
	...
	default Page<Pessoa> findPessoaByNamePage(String nome,Pageable pageable){
		...
		//Configuração da pesquisa para consultar por partes do nome no banco de dados , semelhante ao like com SQL
		ExampleMatcher exampleMatcher = ExampleMatcher.matchingAny()
				.withMatcher("nome", ExampleMatcher.GenericPropertyMatchers.contains().ignoreCase());
	  	
		//União do objeto com o valor e a configuração de consulta
